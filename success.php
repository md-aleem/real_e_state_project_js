...
<head>
    ...
    <link rel="stylesheet" href="./successful/css/style.css">
    ...
    <script>
		...
		url = url.substr(0, url.indexOf('success'));
        //url = url.split('?')[1];
        console.log(url);
	...
	})(window,document,'script','dataLayer','GTM-P5JF4WV');</script> -->
...
<body>
	...
	<!-- <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-P5JF4WV"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="modal-body-div">
                        ...
                        <img src="./successful/successq.gif" class="modal-img" />
    ...
    <script src="./successful/js/index.js"></script>
</body>
